#Projeto simples web feito com flet
#O chat funciona no local host, porém se abrir em duas guias diferentes funciona perfeitamente!
#"Whatsapp 2, Mais lento, menos seguro e pior no geral!"
